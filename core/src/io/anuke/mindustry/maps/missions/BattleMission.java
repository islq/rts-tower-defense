...
public class BattleMission extends MissionWithStartingCore{
    ...
    public Array<GridPoint2> getSpawnPoints(Generation gen){
        ...
        final GridPoint2 gridPoint2;
        if (customStartingPoint != null) {
            gridPoint2 = new GridPoint2(customStartingPoint.x, customStartingPoint.y);
        } else {
            gridPoint2 = new GridPoint2(50, 50);
        }
        return Array.with(gridPoint2, new GridPoint2(gen.width - 1 - spacing, gen.height - 1 - spacing));
    }
