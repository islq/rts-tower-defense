...
public class AboutDialog extends FloatingDialog{
    ...
    public void showCredits(){
        FloatingDialog dialog = new FloatingDialog("$text.about.button");
        dialog.addCloseButton();
        dialog.content().add("开源协议：GPL-3.0");
        dialog.content().row();
        dialog.content().add("https://github.com/islq/rts-tower-defense");
        dialog.content().row();
        dialog.content().add("源代码基于Anuken开源的Mindustry");
        dialog.content().row();
        dialog.content().add("https://github.com/Anuken/Mindustry");
        dialog.content().row();
        dialog.show();
    }
}
