...
public class Drill extends Block{
    ...
    public Drill(String name){
        ...
        consumes.add(new ConsumeLiquid(Liquids.water, 0.05f)).optional(true).update(false);
    }
    ...
    public void update(Tile tile){
        ...
        if(entity.items.total() < itemCapacity && entity.dominantItems > 0 && entity.cons.valid()){
            ...
            // do not comsume water untill it is enough
            if (core.entity.liquids.get(Liquids.water) > 1000 && !liquidRequired) {
                speed = liquidBoostIntensity;
                consumes.get(ConsumeLiquid.class).update(this, entity);
            }
