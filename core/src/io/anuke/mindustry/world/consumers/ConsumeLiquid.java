...
public class ConsumeLiquid extends Consume{
    ...
    public void update(Block block, TileEntity entity){
        ...
        if (core != null) core.entity.liquids.remove(liquid, Math.min(use(block, entity), core.entity.liquids.get(liquid)));
//        entity.liquids.remove(liquid, Math.min(use(block, entity), entity.liquids.get(liquid)));
    ...
    public boolean valid(Block block, TileEntity entity){
        Tile core = Vars.state.getTeamCore(entity.getTeam());
        return core != null && core.entity.liquids.get(liquid) >= use(block, entity);
                // items.has(item, amount);
